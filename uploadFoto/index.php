...
function add ($data) {
    ...
    $query = "INSERT INTO foto VALUES ('', '$judul_foto', '$deskripsi_foto', '$tanggal_unggah', '$lokasi_file', '$user_id')";
    ...
    <input type="hidden" name="user_id" id="user_id">
        ...
        <div class="grid gap-y-4 px-4 py-8">
            ...
            <div class="grid gap-y-2">
                ...
                <input type="text" name="judul_foto" id="judul_foto" class="border-b focus:outline-none text-slate-500 px-2 ">
            </div>
            <div class="grid gap-y-2">
                <label for="deskripsi_foto" class="uppercase text-md text-slate-600">deskripsi foto</label>
                <textarea name="deskripsi_foto" id="deskripsi_foto" class="px-2 py-1 border focus:outline-none text-slate-500 "></textarea>
            </div>
            <div class="grid gap-y-2">
                <label for="tanggal_unggah" class="uppercase text-md text-slate-600">tanggal unggah</label>
                <input type="date" name="tanggal_unggah" id="tanggal_unggah" class="px-2 py-1 border-b focus:outline-none text-slate-500">
            </div>
            <div class="grid gap-y-2">
